...
public class VSyncMonitor {
    ...
    public VSyncMonitor(Context context, VSyncMonitor.Listener listener, float refreshRate) {
        android.util.Log.e("gqg6:", "VSyncMonitor refreshRate=" + refreshRate);
        mListener = listener;
...
//                TraceEvent.end("VSync");
    ...
    public void updateRefreshRate(float refreshRate) {
        android.util.Log.e("gqg6:", "VSyncMonitor updateRefreshRate=" + refreshRate);
    ...
    private void onVSyncCallback(long frameTimeNanos, long currentTimeNanos) {
        ...
        mLastTime = currTime;
        //android.util.Log.e("gqg2:", "onVSyncCallback delay=" + delay);
